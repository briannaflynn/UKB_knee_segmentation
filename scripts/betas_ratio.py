...
# 	print(pd.unique(data_A['beta']))
# 	print(pd.unique(data_B['beta']))
# 	
# 	print(pd.unique(data_A['beta']))	
...
def multiply_by_ratio(data, col_list):
	...
	# This is for if you want to multiply all values by each ratio 
	
# 	data_A["ratio"] = ratio_a
# 	print(data_A["ratio"])
# 	data_B["ratio"] = ratio_b
# 	print(data_B[["xy_group", "ratio"]])

	# This is for if you want to multiply only one set of xy values (B or G group)
