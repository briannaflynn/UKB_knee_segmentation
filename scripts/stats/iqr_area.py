...
data = fname[["file", "femur_area", "tibia_area", "length", "xmax", "all_area_average", "all_area"]].to_dict("list")

cols = ["quad_1_area", "quad_2_area", "quad_3_area", "quad_all_area", "quad_1_area_norm", "quad_2_area_norm", "quad_3_area_norm", "quad_all_area_norm"]
for col in cols:
